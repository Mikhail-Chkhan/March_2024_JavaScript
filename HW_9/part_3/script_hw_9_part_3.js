...
let see_persons = (arr) => {
    ...
    arr.forEach((person, index)=>{
        ...
        age.innerText = 'вік: '+ person.age
        let img = document.createElement('img')
        img.src =`${person.photo}`
        let description = document.createElement('p')
        description.innerText = person.info
        let div_description = document.createElement('div')
        div_description.classList.add('description')
        div_description.append(img,description)
        div.append(name,age,div_description)
        div_box.appendChild(div)
    })
    document.body.appendChild(div_box)
}

see_persons(simpsons)
